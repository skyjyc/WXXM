...
public class JMSWXXMProducer {
    ...
    public void producer() throws JMSException{
         ...
         // 实例化连接工厂  
         connectionFactory = new ActiveMQConnectionFactory(JMSWXXMProducer.USERNAME, JMSWXXMProducer.PASSWORD,  
        		 JMSWXXMProducer.BROKEURL);  
         ...
         try {  
             ...
             destination = session.createTopic("AIRMET");// 创建消息队列  
