...
public class JMSWXXMSubsriber {
    ...
    public static void main(String[] args){  
        ...
        connectionFactory = new ActiveMQConnectionFactory(JMSWXXMSubsriber.USERNAME1, JMSWXXMSubsriber.PASSWORD1, JMSWXXMSubsriber.BROKEURL1);   // 通过连接工厂获取连接  
            try {
