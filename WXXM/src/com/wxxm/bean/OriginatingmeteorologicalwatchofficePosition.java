...
/**
 * OriginatingmeteorologicalwatchofficePosition entity. @author MyEclipse
 * Persistence Tools
 */

public class OriginatingmeteorologicalwatchofficePosition implements java.io.Serializable {
	...
	/** default constructor */
	public OriginatingmeteorologicalwatchofficePosition() {
	}

	/** minimal constructor */
	public OriginatingmeteorologicalwatchofficePosition(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public OriginatingmeteorologicalwatchofficePosition(Integer id, String elevationValue, String elevationUom,
