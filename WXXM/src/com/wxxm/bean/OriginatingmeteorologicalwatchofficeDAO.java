 ...
 * Originatingmeteorologicalwatchoffice entities. Transaction control of the
 ...
 * control.
 * 
 * @see com.wxxm.bean.Originatingmeteorologicalwatchoffice
 * @author MyEclipse Persistence Tools
 */
public class OriginatingmeteorologicalwatchofficeDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(OriginatingmeteorologicalwatchofficeDAO.class);
	// property constants
	...
	public void save(Originatingmeteorologicalwatchoffice transientInstance) {
		log.debug("saving Originatingmeteorologicalwatchoffice instance");
		try {
	...
	public void delete(Originatingmeteorologicalwatchoffice persistentInstance) {
		log.debug("deleting Originatingmeteorologicalwatchoffice instance");
		try {
	...
	public Originatingmeteorologicalwatchoffice findById(java.lang.Integer id) {
		log.debug("getting Originatingmeteorologicalwatchoffice instance with id: " + id);
		try {
			Originatingmeteorologicalwatchoffice instance = (Originatingmeteorologicalwatchoffice) getSession()
					.get("com.wxxm.bean.Originatingmeteorologicalwatchoffice", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Originatingmeteorologicalwatchoffice instance) {
		log.debug("finding Originatingmeteorologicalwatchoffice instance by example");
		try {
			List results = getSession().createCriteria("com.wxxm.bean.Originatingmeteorologicalwatchoffice")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Originatingmeteorologicalwatchoffice instance with property: " + propertyName + ", value: "
				+ value);
		try {
			String queryString = "from Originatingmeteorologicalwatchoffice as model where model." + propertyName
					+ "= ?";
	...
	public List findAll() {
		log.debug("finding all Originatingmeteorologicalwatchoffice instances");
		try {
			String queryString = "from Originatingmeteorologicalwatchoffice";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public Originatingmeteorologicalwatchoffice merge(Originatingmeteorologicalwatchoffice detachedInstance) {
		log.debug("merging Originatingmeteorologicalwatchoffice instance");
		try {
			Originatingmeteorologicalwatchoffice result = (Originatingmeteorologicalwatchoffice) getSession()
	...
	public void attachDirty(Originatingmeteorologicalwatchoffice instance) {
		log.debug("attaching dirty Originatingmeteorologicalwatchoffice instance");
		try {
	...
	public void attachClean(Originatingmeteorologicalwatchoffice instance) {
		log.debug("attaching clean Originatingmeteorologicalwatchoffice instance");
		try {
