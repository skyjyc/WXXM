...
/**
 * OriginatingmeteorologicalwatchofficeAvailability entity. @author MyEclipse
 * Persistence Tools
 */

public class OriginatingmeteorologicalwatchofficeAvailability implements java.io.Serializable {
	...
	/** default constructor */
	public OriginatingmeteorologicalwatchofficeAvailability() {
	}

	/** minimal constructor */
	public OriginatingmeteorologicalwatchofficeAvailability(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public OriginatingmeteorologicalwatchofficeAvailability(Integer id, String timeReferenceValue,
