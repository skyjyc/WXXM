...
/**
 * Originatingmeteorologicalwatchoffice entity. @author MyEclipse Persistence
 * Tools
 */

public class Originatingmeteorologicalwatchoffice implements java.io.Serializable {
	...
	/** default constructor */
	public Originatingmeteorologicalwatchoffice() {
	}

	/** minimal constructor */
	public Originatingmeteorologicalwatchoffice(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public Originatingmeteorologicalwatchoffice(Integer id, String unitNamevalue, String unitNamenilReason,
			String typevalue, String typenilReason, String compliantIcaovalue, String compliantIcaonilReason,
			String designatorvalue, String designatornilReason, String militaryvalue, String militarynilReason,
			Short owns, String nilReason, String remoteSchema, String type, String href, String role, String arcrole,
			String title, String show, String actuate, Short unitTypeowns) {
		this.id = id;
