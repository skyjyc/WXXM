 ...
 * OriginatingmeteorologicalwatchofficeAvailability entities. Transaction
 ...
 * control.
 * 
 * @see com.wxxm.bean.OriginatingmeteorologicalwatchofficeAvailability
 * @author MyEclipse Persistence Tools
 */
public class OriginatingmeteorologicalwatchofficeAvailabilityDAO extends BaseHibernateDAO {
	private static final Log log = LogFactory.getLog(OriginatingmeteorologicalwatchofficeAvailabilityDAO.class);
	// property constants
	...
	public void save(OriginatingmeteorologicalwatchofficeAvailability transientInstance) {
		log.debug("saving OriginatingmeteorologicalwatchofficeAvailability instance");
		try {
	...
	public void delete(OriginatingmeteorologicalwatchofficeAvailability persistentInstance) {
		log.debug("deleting OriginatingmeteorologicalwatchofficeAvailability instance");
		try {
	...
	public OriginatingmeteorologicalwatchofficeAvailability findById(java.lang.Integer id) {
		log.debug("getting OriginatingmeteorologicalwatchofficeAvailability instance with id: " + id);
		try {
			OriginatingmeteorologicalwatchofficeAvailability instance = (OriginatingmeteorologicalwatchofficeAvailability) getSession()
					.get("com.wxxm.bean.OriginatingmeteorologicalwatchofficeAvailability", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(OriginatingmeteorologicalwatchofficeAvailability instance) {
		log.debug("finding OriginatingmeteorologicalwatchofficeAvailability instance by example");
		try {
			List results = getSession().createCriteria("com.wxxm.bean.OriginatingmeteorologicalwatchofficeAvailability")
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding OriginatingmeteorologicalwatchofficeAvailability instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from OriginatingmeteorologicalwatchofficeAvailability as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all OriginatingmeteorologicalwatchofficeAvailability instances");
		try {
			String queryString = "from OriginatingmeteorologicalwatchofficeAvailability";
			Query queryObject = getSession().createQuery(queryString);
			return queryObject.list();
		} catch (RuntimeException re) {
	...
	public OriginatingmeteorologicalwatchofficeAvailability merge(
			OriginatingmeteorologicalwatchofficeAvailability detachedInstance) {
		log.debug("merging OriginatingmeteorologicalwatchofficeAvailability instance");
		try {
			OriginatingmeteorologicalwatchofficeAvailability result = (OriginatingmeteorologicalwatchofficeAvailability) getSession()
	...
	public void attachDirty(OriginatingmeteorologicalwatchofficeAvailability instance) {
		log.debug("attaching dirty OriginatingmeteorologicalwatchofficeAvailability instance");
		try {
	...
	public void attachClean(OriginatingmeteorologicalwatchofficeAvailability instance) {
		log.debug("attaching clean OriginatingmeteorologicalwatchofficeAvailability instance");
		try {
