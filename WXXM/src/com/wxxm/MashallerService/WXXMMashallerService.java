...
public class WXXMMashallerService {
  public String mashaller(Integer id){
	  ...
	  Issuingairtrafficservicesunit issuingairtrafficservicesunit=issuingairtrafficservicesunitDAO.findById(id);
...
buf=bytearrayoutputstream.toString();
try {
